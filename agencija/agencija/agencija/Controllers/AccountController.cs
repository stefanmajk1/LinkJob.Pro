...
namespace agencija.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult UserAccount(Korisnik k, HttpPostedFileBase image)
        {
            ...
            {
                var userToReturn = db.Korisniks.Find(k.IdKorisnik);
                ViewBag.ErrorMessage = "Invalid data for the picture!";
                return View(userToReturn);
            }
            if (k.Ime == null || k.Prezime == null || k.Sifra == null ||
                    k.Telefon == null ||
                    k.Email == null)
            {
                var userToReturn = db.Korisniks.Find(k.IdKorisnik);
                ViewBag.ErrorMessage = "Fields can not be empty!";
                return View(userToReturn);
            }
            ...
            using (var context = new Agencija_Context())
            {
                ...
                if(userToUpdate != null)
                {
                    ...
                    context.SaveChanges();
                    ViewBag.Success = "Changes were successfull.";
                    return View(userToUpdate);
                }
                else
                {
                    ViewBag.ErrorMessage = "Invalid data to the fields.";
                    return View(k);
                }
            }
        }
